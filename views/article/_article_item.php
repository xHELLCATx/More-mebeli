...
<div class="card h-100">
    ' . ($model->image ? '<img class="card-img-top" style="height: 500px; object-fit: cover;" src="' . Url::to('@web/' . $model->image) . '" alt="' . Html::encode($model->title) . '">' : '') . '
...
echo Html::a($cardContent, ['view', 'id' => $model->id], ['class' => 'text-decoration-none text-dark']);
?>
